...
namespace UserStrory
{
    public partial class StudentInfoForm : Form
    {
        ...
        public StudentInfoForm(Student source):this()
        {
            this.Text = "Редактирование студента";
            Name.Text = source.FullName;
            comboBox1.SelectedItem = source.Gender;
            dateTimePicker1.Value = student.BirthDay;
            numericUpDown1.Value = source.AvgRate;
            Deduct1.Checked = source.Deduct;
            Debtor1.Checked = source.Debtor;
        }
