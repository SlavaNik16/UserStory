...
namespace UserStory4Tours
{
    public partial class Form1 : Form
    {
        ...
        private decimal sum = 0, sumAllSur = 0, sumAll;
        private int i = 0;
        private decimal[] AllMas = new decimal[20];
        ...
        private void CalculatScroll()
        {
            ...
            sumAllSur = ToursGridViev.Rows.Cast<DataGridViewRow>().AsEnumerable().Sum(x => (decimal)x.Cells["SurColumn"].Value);
