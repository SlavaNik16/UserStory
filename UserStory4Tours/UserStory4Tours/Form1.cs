...
namespace UserStory4Tours
{
    public partial class Form1 : Form
    {
        ...
        private decimal sum = 0, sumAll = 0;
        ...
        private void AddTool_Click(object sender, EventArgs e)
        {
            ...
            if (infoForm.ShowDialog(this) == DialogResult.OK)
            {
                ...
                sumAll += (infoForm.Tours.NumberNight * infoForm.Tours.NumberVac * infoForm.Tours.CostVac) + infoForm.Tours.Surcharges;
                CalculatScroll();
        ...
        private void DeliteTool_Click(object sender, EventArgs e)
        {
            ...
            if(MessageBox.Show($"Вы действительно хотите удалить {id.DateDeparture:D}",
                "Удаление записи", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                tours.Remove(id);
                BinSource.ResetBindings(false);
                sumAll -= (id.NumberNight * id.NumberVac * id.CostVac) + id.Surcharges;
                CalculatScroll();
        ...
        private void CalculatScroll()
        {
            ...
            decimal sumAllSur = ToursGridViev.Rows.Cast<DataGridViewRow>().AsEnumerable().Sum(x => (decimal)x.Cells["SurColumn"].Value);
